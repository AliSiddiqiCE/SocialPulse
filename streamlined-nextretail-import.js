...
async function streamlinedImport() {
  console.log('Streamlined completion of all Next Retail datasets\n');
  
  let newRecords = 0;
  
  // Complete TikTok Hashtag (918/947 remaining: 29)
  ...
  for (let i = 919; i < hashtagLines.length && hashtagCompleted < 29; i++) {
