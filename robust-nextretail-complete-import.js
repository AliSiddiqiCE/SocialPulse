...
async function robustCompleteImport() {
  console.log('Robust completion of all Next Retail datasets\n');
  
  // Complete TikTok Hashtag (789/947 remaining: 158)
  console.log('Completing TikTok Hashtag (158 remaining)...');
  ...
  for (let i = 790; i < hashtagLines.length && hashtagCompleted < 158; i++) {
  ...
  console.log(`TikTok Hashtag: ${hashtagCompleted} final records`);
