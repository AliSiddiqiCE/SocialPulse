...
import { getKeyTopicsBySentiment, getPostFrequency } from './storage';
import { extractAndAnalyzeSentiments } from './sentiment-analyzer';
...
(async () => {
  ...
  // Run sentiment analysis extraction on startup
  try {
  ...
  // Using port 5003 to avoid conflicts with other services
