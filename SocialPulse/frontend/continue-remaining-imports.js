...
async function continueRemainingImports() {
  console.log('Continuing remaining Next Retail imports\n');
  
  let newRecords = 0;
  
  // Complete YouTube Hashtag (99/1044 remaining: 945)
  console.log('Completing YouTube Hashtag (945 remaining)...');
  ...
  for (let i = 100; i < youtubeHashtagLines.length && youtubeHashtagCompleted < 945; i++) {
...
async function main() {
  try {
    await continueRemainingImports();
  } catch (error) {
