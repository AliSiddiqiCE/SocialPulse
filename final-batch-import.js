...
async function finalBatchImport() {
  console.log('Final batch completion of all Next Retail datasets\n');
  
  let newRecords = 0;
  
  // Complete YouTube Hashtag (354/1044 remaining: 690)
  console.log('Completing YouTube Hashtag (690 remaining)...');
  ...
  for (let i = 355; i < youtubeHashtagLines.length && youtubeHashtagCompleted < 690; i++) {
  ...
  if (grandTotal >= 4300) {
    console.log('*** NEXT RETAIL IMPORT SUCCESSFULLY COMPLETED ***');
    console.log('All datasets imported with exact column preservation');
  } else {
    console.log('Import continuing - preserving exact column structure');
  }
